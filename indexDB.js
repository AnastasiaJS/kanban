 ...
 **/
export const addData = function (db, storeName, dataConfig) {
    return new Promise((resolve, reject) => {
        if (!db) {
            reject("数据库不存在或没有初始化");
        }
 ...
 **/
export const getData = function (db, storeName, key) {
    return new Promise((resolve, reject) => {
        if (!db) {
            reject("数据库不存在或没有初始化");
        }
 ...
 * @param {string} key 数据主键
 **/
export const deleteData = function (db, storeName, key) {
    return new Promise((resolve, reject) => {
        if (!db) {
            reject("数据库不存在或没有初始化");
        }
 ...
 * resolve({ code: 0, success: true, data: data, msg: "数据查询成功!" });
 * reject({ code: -1, success: false, data: null, msg: "数据查询失败!" });
 **/
